...
public class EmployeeViewUpcomingMeeting extends javax.swing.JFrame {

    /**
     * Creates new form Decisions
     */
    public EmployeeViewUpcomingMeeting() {
        initComponents();
//        fill_Combo();
        //  fill_listDecisions();
...
//            meetingCombo.setModel(dlm);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UPCOMING MEETINGS");
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 170, -1, -1));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 170, 30, 40));

        jPanel5.setBackground(new java.awt.Color(52, 152, 219));
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 170, 30, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeViewUpcomingMeeting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeViewUpcomingMeeting().setVisible(true);
            }
        });
    }
